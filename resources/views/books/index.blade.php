                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Adventure III" aria-label="Title" aria-describedby="basic-addon1">
                          </div>                          
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="year" class="form-control" placeholder="1970" aria-label="year" aria-describedby="basic-addon1">
                          </div>                          
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="isbn"  class="form-control" placeholder="AB-125AC-55" aria-label="ISBN" aria-describedby="basic-addon1">
                          </div>                          
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text"  name="editorial" class="form-control" placeholder="Cometa" aria-label="Editorial" aria-describedby="basic-addon1">
                          </div>                          
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number"  name="edition" class="form-control" placeholder="II" aria-label="Edition" aria-describedby="basic-addon1">
                          </div>                          
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text"  name="autor" class="form-control" placeholder="Robert James" aria-label="Autor" aria-describedby="basic-addon1">
                          </div>                          
